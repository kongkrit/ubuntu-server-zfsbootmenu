...
user="kadmin" #Username for new install.
PASSWORD="h" #Password for user in new install.
hostname="server" #Name to identify the main system on the network. An underscore is DNS non-compliant.
...
topology_data="mirror" #"single", "mirror", "raid0", "raidz1", "raidz2", or "raidz3" topology on data pool.
disks_data="2" #Number of disks in array for data pool. Not used with single topology.
